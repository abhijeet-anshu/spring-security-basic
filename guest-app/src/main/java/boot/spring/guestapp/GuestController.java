package boot.spring.guestapp;


import boot.spring.guestapp.domain.Guest;
import boot.spring.guestapp.domain.GuestModel;
import boot.spring.guestapp.service.GuestService;
